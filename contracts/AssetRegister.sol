...
contract AssetRegister is ERC1155 {
    ...
    function _registerAsset(
        ...
        if (assetId == 0) {
            ...
            // Prevents getting shares for a future token whose address is known in advance. For instance a token that will be deployed with CREATE2
            // in the future or while the contract creation is in the mempool
